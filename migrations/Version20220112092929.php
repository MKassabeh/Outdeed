 ...
 */
final class Version20220112092929 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE company (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, name VARCHAR(100) NOT NULL, description LONGTEXT NOT NULL, category VARCHAR(50) NOT NULL, contact_email VARCHAR(100) NOT NULL, city VARCHAR(100) NOT NULL, phone VARCHAR(20) NOT NULL, nb_employees INT DEFAULT NULL, created_at DATETIME NOT NULL, INDEX IDX_4FBF094FA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
